...
mxdiflg(a1, a2)
// --------------------------------------------------------------------
const arr = [3,5,3,'sdd',453,1]
const arr1 = [
  { name: 'hafidz', gender: 'male', nationality: 'indonesia'},
  { name: 'ilham', gender: 'male', nationality: 'saudi arabia'},
  { name: 'aji', gender: 'female', nationality: 'malaysia'}
]
const arr2 = { focal_length: '18mm', aperture: 'f/8', brand: 'canon' }
